...
export const makeAdminActionsService = asServiceProvider(({ database, rando, fetchUsers, }) => ({ user, }) => ({
    async banUser(rawData) {
    ...
    async listBans(rawData) {
        ...
        if (!(user === null || user === void 0 ? void 0 : user.permissions.canListBanUsers))
