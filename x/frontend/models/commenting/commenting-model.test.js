    ...
    "archiving comments": {
        ...
        "an admin user": {
            ...
            async "cannot archive an empty array of comment ids"() {
                ...
                expect(error === null || error === void 0 ? void 0 : error.code).equals(400);
            },
        }
    },
    "posting reviews with scores": {
        "a logged-in user": {
            async "can post a review, with a score, and see it"() {
                ...
                expect((_a = commenting.getComments(topicId)[0].scoring) === null || _a === void 0 ? void 0 : _a.scores).ok();
                expect((_b = commenting.getComments(topicId)[0].scoring) === null || _b === void 0 ? void 0 : _b.average).equals(55);
            },
            async "can post a review, and see it in a new tab"() {
                ...
                expect((_a = tab2.commenting.getComments(topicId)[0].scoring) === null || _a === void 0 ? void 0 : _a.scores).ok();
                expect((_b = tab2.commenting.getComments(topicId)[0].scoring) === null || _b === void 0 ? void 0 : _b.average).equals(55);
            },
        },
    },
    "board stats": {
        async "work on board with a single review"() {
            ...
            expect((_a = stats.scoring) === null || _a === void 0 ? void 0 : _a.averageScore).equals(50);
        },
        async "work on board with two reviews"() {
            ...
            expect(stats.replyCount).equals(0);
            expect(stats.scoring).ok();
            expect((_a = stats.scoring) === null || _a === void 0 ? void 0 : _a.averageScore).equals(55);
        },
    },
    utils: { computeNestedCommentsTest },
};
//# sourceMappingURL=commenting-model.test.js.map