		...
		Object.entries(object).flatMap(
			([key, value]) =>
				schematicKeys.includes(key)
					? (<Validator<any>>(<any>schematic)[key])(value)
...
export function optional<xValue>(...conditions: Validator<any>[]): Validator<xValue> {
	return branch(
		validator<any>(notDefined()),
		...conditions,
	)
}
...
export const notAllWhitespace = (): Validator<string> => value =>
